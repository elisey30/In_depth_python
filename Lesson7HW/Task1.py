...
def rename_files(new_name, num_digits, src_extension, dst_extension, name_slice, directory=None):
    ...
    :param src_extension: Расширение исходных файлов для переименования
    :param dst_extension: Расширение конечных файлов
    :param name_slice: Диапазон сохраняемого оригинального имени (tuple, например, (3, 6))
    :param directory: Путь к каталогу с файлами для переименования (опционально)
    """
